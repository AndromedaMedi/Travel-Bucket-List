...
country14 = Country("Canada", user1, True)
country_repository.save(country14)
country15 = Country("Albania", user1, True)
country_repository.save(country15)
country16 = Country("Turkey", user1, True)
...
city21 = City("Edinburgh", country6, user1, True)
...
city24 = City("Newcastle", country5, user1, True)
city_repository.save(city24)
city25 = City("Valencia", country9, user1, True)
city_repository.save(city25)
city26 = City("Madrid", country9, user1, False)
city_repository.save(city26)
city27 = City("Marseille", country4, user1, False)
city_repository.save(city27)
city28 = City("Bordeaux", country4, user1, False)
city_repository.save(city28)
city29 = City("Toronto", country14, user1, True)
city_repository.save(city29)
city30 = City("Valencia", country9, user1, True)
city_repository.save(city30)
city31 = City("Kefalonia", country1, user1, True)
city_repository.save(city31)
city32 = City("Ithaki", country1, user1, True)
city_repository.save(city32)
city33 = City("Rethymno", country1, user1, True)
city_repository.save(city33)
city34 = City("Frankfurt", country2, user1, True)
city_repository.save(city34)
city35 = City("Hamburg", country2, user1, True)
city_repository.save(city35)
city36 = City("Korça", country15, user1, True)
city_repository.save(city36)
city37 = City("Tirana", country15, user1, True)
city_repository.save(city37)
city38 = City("Instabul", country16, user1, True)
city_repository.save(city38)
